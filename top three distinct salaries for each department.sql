...
INSERT INTO employees (id, first_name, last_name, age, sex, employee_title, department, salary, target, bonus, city, address, manager_id) VALUES
...
-- 1) Keep only distinct non-null salaries per department
...
-- 2) Rank salaries inside each department
ranked_salaries AS (
    SELECT
        department,
        salary,
